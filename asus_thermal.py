...
def setfan():
    ...
    time.sleep(2)
    os.system('echo 2 | sudo tee /sys/devices/platform/asus-nb-wmi/hwmon/hwmon2/pwm1_enable')
...
while True:
    ...
    #if temp > 90:
    #    beep()
    os.system("echo 'temp: %d C,fan: %d' | osd_cat --lines=1 --font='lucidasanstypewriter-bold-8'" % (temp,rpm))
    time.sleep(2)
