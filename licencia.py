...
def init_holidays(year):
    ...
    return [  # feriados no laborables
        ...
        semana_santa[
            4
        ],  # viernes de la muerte, no se puede comer carne pero yo la como igual.
        carnaval[0],  # dia de las morenas carnosas bailando
        carnaval[1],  # dia de las morenas carnosas bailando
        # feriados laborables
        date(
            year=year, month=6, day=19
        ),  # el dia en que artigas se emborracho (porque era su cumplenios)
